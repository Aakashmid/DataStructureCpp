...
void DLL::insert(int x, int index = -1)
{
    if (index == -1)
    {
        addtotail(x);
...
int main()
{
    ...
    d.deletefromtail();
    d.Delete(4);
    cout<<"Before reversing linked list elements are :";
    d.display();
    cout<<endl;  
    d.reverse();
    cout<<"After reversing linked list elements are :" ;
    d.display();  
    return 0;
}